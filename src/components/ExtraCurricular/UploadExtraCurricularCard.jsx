...
const UploadExtraCurricularCard = ({ onUploadClick }) => {
  return (
    <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-4">
      ...
      <div className="border-2 border-dashed border-slate-200 rounded-lg px-6 py-8 flex flex-col items-center justify-center text-center hover:border-blue-400 transition">
